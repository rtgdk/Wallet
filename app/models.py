...
class Total(models.Model):
	...
	totalamount = models.IntegerField("Funds left",default=0,null=False)
	tincome = models.IntegerField("Total Earned",default=0,null=False)
	texpense = models.IntegerField("Total Spent",default=0,null=False)
	def __str__(self):
